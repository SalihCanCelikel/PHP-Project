...
<a href="sepete_ekle.php" class="text-white sepete-ekle" id="<?php echo $kayit['id']?>"><i
...
$kayit['resim']?>" alt="<?php echo $kayit['urunadi']?>">
 ...
 <a href="sepete_ekle.php" class="text-secondary float-left sepete-ekle" id="<?php echo
